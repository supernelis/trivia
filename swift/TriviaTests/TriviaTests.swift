...
class TriviaTests: XCTestCase {
    ...
    func test_GoldenMaster() throws {
        let players = [ ["Nelis","Angel","Tim","Tom","Tam"],
                        ["Nelis","Angel","Tim","Tom"],
                        ["Nelis","Angel","Tim"],
                        ["Nelis","Angel"],
                        ["Angel","Nelis"],
        ...
        var output = ""
        players.forEach( { players in
         output += runTestsWithPlayers(players)
        })
        
        XCTAssertEqual(GoldenMaster.output, output)
    }
    
   func runTestsWithPlayers(_ players: [String]) -> String {
